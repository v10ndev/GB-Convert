...
public class OAuth2LoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		String provinceCode = request.getLocale().getCountry();
		...
		LOGGER.info("OAuth2LoginSuccessHandler | onAuthenticationSuccess |  provinceCode : " + provinceCode);
		...
		if (customer == null) {
			customerService.addNewCustomerUponOAuthLogin(name, email, provinceCode, authenticationType);
		} else {
