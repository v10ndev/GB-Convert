...
import com.shopme.repository.ProvinceRepository;
...
//		LOGGER.info("CustomerService | updateAuthenticationType |  customer : " + customer.toString());
	...
	@Override
	public void addNewCustomerUponOAuthLogin(String name, String email, String provinceCode,
		...
		customer.setProvince(provinceRepo.findByCode(provinceCode));
