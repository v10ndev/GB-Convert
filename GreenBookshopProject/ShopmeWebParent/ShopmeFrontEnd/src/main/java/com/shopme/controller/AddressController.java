...
public class AddressController {
	...
	public String showAddressBook(Model model, HttpServletRequest request) throws CustomerNotFoundException {
		...
		LOGGER.info("AddressController | showAddressBook | customer : ");
	...
	public String newAddress(Model model) {
		...
		List<Province> listProvinces = customerService.listAllProvinces();

		model.addAttribute("listProvinces", listProvinces);
		model.addAttribute("address", new Address());
		model.addAttribute("pageTitle", "Add New Address");
		
		LOGGER.info("AddressController | newAddress | listProvinces : " + listProvinces.toString());
	...
	public String editAddress(@PathVariable("id") Integer addressId, Model model,
		...
		LOGGER.info("AddressController | editAddress | listProvinces : " + listProvinces.toString());
