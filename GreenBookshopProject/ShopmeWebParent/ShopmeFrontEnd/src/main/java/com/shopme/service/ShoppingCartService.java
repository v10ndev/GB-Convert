	...
	public Integer addProduct(Integer productId, Integer quantity, Customer customer) throws ShoppingCartException {
		...
		if (cartItem != null) {
			...
			if (updatedQuantity > 5) {
				...
				throw new ShoppingCartException("Không thể thêm vào " + quantity + " mặt hàng"
						+ " Bởi vì đã có " + cartItem.getQuantity() + " mặt hàng "
						+ "trong giỏ hàng của bạn. Số lượng tối đa cho phép là 5.");
			}
		} else {
