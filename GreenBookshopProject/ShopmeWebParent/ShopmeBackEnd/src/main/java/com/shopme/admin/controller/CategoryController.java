...
public class CategoryController {
	...
	private String defaultRedirectURL = "redirect:/categories/page/1?sortField=firstName&sortDir=asc";
...
//			AmazonS3Util.uploadFile(uploadDir, fileName, multipartFile.getInputStream());
		...
		ra.addFlashAttribute("messageSuccess", "Thể loại đã được lưu thành công.");
	...
	public String updateCategoryEnabledStatus(@PathVariable("id") Integer id,
		...
		String message = "Thể loại ID " + id + " đã được " + status;
...
//			LOGGER.info("CategoryController | deleteCategory | FileUploadUtil.removeDir is over");
			...
			redirectAttributes.addFlashAttribute("messageSuccess", 
					"Thể loại ID " + id + " đã bị xóa thành công");
